...
const HomeHeader = (): ReactNode => {
    ...
    return (
        <header className='hidden sm:block fixed top-0 left-0 w-full bg-gray-900/90 backdrop-blur-md z-50 shadow-md'>
            <div className="text-[12px] flex flex-row justify-end p-2">
                <Link target="_blank" 
                    href={urlApiDocs} 
                    className='text-[12px] bg-[#3e2eb3] text-white px-3 py-1.5 sm:px-4 sm:py-2 font-medium rounded-md hover:brightness-105 hover:shadow-md transition'>
                    API Docs
                </Link>
            </div>
        </header>
